    	...
    	{   
    	    ...
    	    if(Noeigen_hw>0)
    	    {
    	    	if(TheNamedObjMap::Instance().check(HW_eigen)){
    	    		Hw=(HwilsonEigenOperator*)TheNamedObjMap::Instance().getData<EigenOperator<LatticeFermion>* >
    	    			(HW_eigen);
...
//	        ApplyOverlapQuda0(spinorOut,spinorIn,&quda_inv_param,k0,k1,k2,prec,(void *)&ov_param);
